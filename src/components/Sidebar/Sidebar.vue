      ...
      >
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none">
          <li class="items-center">
            ...
            >
              ...
              >
                <i
                  class="fa-solid fa-tv mr-2 text-sm"
          ...
          <li class="items-center">
            ...
            >
              ...
              >
                <i
                  class="fa-solid fa-tools mr-2 text-sm"
                  :class="[isActive ? 'opacity-75' : 'text-slate-300']"
                ></i>
                Settings
              </a>
          ...
          <li class="items-center">
            ...
            >
              ...
              >
                <i
                  class="fa-solid fa-table mr-2 text-sm"
                  :class="[isActive ? 'opacity-75' : 'text-slate-300']"
                ></i>
                Tables
              </a>
          ...
          <li class="items-center">
            <router-link to="/admin/maps" v-slot="{ href, navigate, isActive }">
              ...
              >
                <i
                  class="fa-solid fa-map-marked mr-2 text-sm"
                  :class="[isActive ? 'opacity-75' : 'text-slate-300']"
                ></i>
                Maps
              </a>
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
          ...
          <li class="items-center">
            ...
            >
              <i
                class="fa-solid fa-clipboard-list text-slate-300 mr-2 text-sm"
              ></i>
              Register
            </router-link>
          </li>
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
          <li class="items-center">
            <router-link
              ...
              to="/landing"
            >
              <i class="fa-solid fa-newspaper text-slate-300 mr-2 text-sm"></i>
              Landing Page
            </router-link>
          </li>
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
          <li class="inline-flex">
            ...
            >
              <i
                class="fa-solid fa-paint-brush mr-2 text-slate-300 text-base"
              ></i>
              Styles
            </a>
          </li>
          ...
          <li class="inline-flex">
            <a
              ...
              class="text-slate-700 hover:text-slate-500 text-sm block mb-4 no-underline font-semibold"
            >
              <i class="fa-brands fa-angular mr-2 text-slate-300 text-base"></i>
              Angular
            </a>
          </li>
          ...
          <li class="inline-flex">
            <a
              ...
              class="text-slate-700 hover:text-slate-500 text-sm block mb-4 no-underline font-semibold"
            >
              <i class="fa-brands fa-react mr-2 text-slate-300 text-base"></i>
              NextJS
            </a>
          </li>
          ...
          <li class="inline-flex">
            <a
              ...
              class="text-slate-700 hover:text-slate-500 text-sm block mb-4 no-underline font-semibold"
            >
              <i class="fa-solid fa-link mr-2 text-slate-300 text-base"></i>
              Svelte
            </a>
          </li>
          ...
          <li class="inline-flex">
            <a
              ...
              class="text-slate-700 hover:text-slate-500 text-sm block mb-4 no-underline font-semibold"
            >
              <i class="fa-brands fa-vuejs mr-2 text-slate-300 text-base"></i>
              VueJS
            </a>
          </li>
        </ul>
