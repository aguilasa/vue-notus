      ...
      >
        <ul class="flex flex-col lg:flex-row list-none mr-auto">
          <li class="flex items-center">
            ...
            >
              <i
                class="lg:text-slate-200 text-slate-400 fa-regular fa-file-alt text-lg leading-lg mr-2"
              />
              Docs
            </a>
          </li>
        ...
        <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
          ...
          <li class="flex items-center">
            ...
            >
              <i
                class="lg:text-slate-200 text-slate-400 fa-brands fa-facebook text-lg leading-lg"
              />
          ...
          <li class="flex items-center">
            ...
            >
              <i
                class="lg:text-slate-200 text-slate-400 fa-brands fa-twitter text-lg leading-lg"
              />
          ...
          <li class="flex items-center">
            ...
            >
              <i
                class="lg:text-slate-200 text-slate-400 fa-brands fa-github text-lg leading-lg"
              />
          ...
          <li class="flex items-center">
            <button
              ...
              type="button"
            >
              <i class="fa-solid fa-arrow-alt-circle-down"></i> Download
            </button>
          </li>
        </ul>
      </div>
