  ...
  >
    <div class="px-6">
      ...
      <div class="text-center mt-12">
        ...
        >
          <i class="fa-solid fa-map-marker-alt mr-2 text-lg text-slate-400"></i>
          Los Angeles, California
        </div>
        <div class="mb-2 text-slate-600 mt-10">
          <i class="fa-solid fa-briefcase mr-2 text-lg text-slate-400"></i>
          Solution Manager - Creative Tim Officer
        </div>
        <div class="mb-2 text-slate-600">
          <i class="fa-solid fa-university mr-2 text-lg text-slate-400"></i>
